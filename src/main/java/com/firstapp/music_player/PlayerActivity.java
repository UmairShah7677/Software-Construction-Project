package com.firstapp.music_player;
...
public class PlayerActivity extends AppCompatActivity {
    ...
    SeekBar seekmusic;
    BarVisualizer visualizer; //barvisualizer
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Music Being Played");
        ...
        visualizer = findViewById(R.id.blast); //barvisualizer
        ...
        //on song completion, play next song listener
